...
import (
	...
	"bennsimon.github.io/workload-scheduler-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(workloadschedulerv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "db5acf10.bennsimon.github.io",
	...
	if err = (&controller.ScheduleReconciler{
		Client:           mgr.GetClient(),
		Scheme:           mgr.GetScheme(),
		IScheduleHandler: scheduleHandler.New(),
	}).SetupWithManager(mgr); err != nil {
